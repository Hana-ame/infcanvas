...
describe('插件化：正向组装（内核引擎 + 玩法包 = 最终模拟器）', () => {
  ...
  it('默认装配 = 52 系统（field-command + beastTaming 2026-08-20 加入），且执行序 = 类别推导序（EXPECTED_ORDER 快照）', () => {
